  ...
  try
  {
    ...
    switch(gUserProfile.loginAnswerCode) 
    {
      ...
      case CLoginHelper::ANS_Banned:
        ...
        MessageBox(NULL, "Your account has been permanently banned", "Login", MB_OK | MB_ICONSTOP);
        break;
      ...
      case CLoginHelper::ANS_Unknown:
        ...
        MessageBox(NULL, "Unknown account status, please contact support@thewarz.com", "Login", MB_OK | MB_ICONEXCLAMATION);
        break;
...
void CUpdater::DoApplyNewKey(const char* key)
{
  ...
  switch(req.resultCode_)
  {
    ...
    case 2:
      MessageBox(NULL, "Your account type can not be updated, please contact support@thewarz.com", "Update Account", MB_OK);
      break;
