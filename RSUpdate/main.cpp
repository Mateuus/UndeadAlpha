...
static void drawTimeExpiredButtons(CUpdater& updater)
{
  ...
  if(insideRect(g_rGetNewKeyBtn, g_mx, g_my)) 
  {
    ...
    if(g_mb) 
    {
      ShellExecute(NULL, "open", "http://www.thewarz.com/buy?ref=WarE", "", NULL, SW_SHOW);
    }
  }
...
static void drawSerialCheckButtons(CUpdater& updater)
{
  ...
  if(insideRect(g_rGetSerialBtn, g_mx, g_my)) 
  {
    ...
    if(g_mb) 
    {
      ShellExecute(NULL, "open", "http://www.thewarz.com/buy?ref=WarL", "", NULL, SW_SHOW);
    }
  }
...
static void drawLoginButtons(CUpdater& updater)
{
  ...
  if(drawUrl(481, 445, "Forgot Password?")) {
    ShellExecute(NULL, "open", "https://account.thewarz.com/account_check/", "", NULL, SW_SHOW);
  }
...
static void executeTopMenuButton(const CUpdater& updater, int btnIdx)
{
  ...
  switch(btnIdx)
  {
    ...
    {
      char url[1024];
      sprintf(url, "https://account.thewarz.com/?WzLogin=%s", token);
    ...
    case 1: // forums
    {
      ShellExecute(NULL, "open", "http://forums.thewarz.com", "", NULL, SW_SHOW);
      break;
    }

    case 2: // support
    {
      ShellExecute(NULL, "open", "http://support.thewarz.com", "", NULL, SW_SHOW);
      break;
    }
    
    case 3: // youtube
    {
      ShellExecute(NULL, "open", "http://www.youtube.com/user/TheWarZMMO", "", NULL, SW_SHOW);
      break;
    }
    
    case 4: // facebook
    {
      ShellExecute(NULL, "open", "http://www.facebook.com/warzmmo", "", NULL, SW_SHOW);
      break;
    }
    
    case 5: // twitter
    {
      ShellExecute(NULL, "open", "http://twitter.com/#!/The_War_Z", "", NULL, SW_SHOW);
      break;
    }
  }
