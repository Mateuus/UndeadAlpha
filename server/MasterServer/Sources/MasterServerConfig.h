...
class CMasterServerConfig
{
  public:
	...
	void		 ParsePermamentGame(int gameServerId, const char* name, const char* map, const char* data, const char* PasswordGame, const char* MapSettings, const char* enableSnipers);
